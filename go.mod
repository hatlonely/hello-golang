module github.com/hatlonely/hello-golang
...
require (
	...
	github.com/eko/gocache/store/hazelcast/v4 v4.2.0 // indirect
	github.com/eko/gocache/store/memcache/v4 v4.2.2 // indirect
	github.com/eko/gocache/store/pegasus/v4 v4.2.2 // indirect
	...
	github.com/eko/gocache/store/rueidis/v4 v4.1.6 // indirect
